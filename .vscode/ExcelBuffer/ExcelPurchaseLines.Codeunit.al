Codeunit 87989 "wan Excel Purchase Lines"
{
    trigger OnRun()
    begin
    end;
    ...
    local procedure InsertLine(var pRec: Record "Purchase Line"; pToRec: Record "Purchase Line")
    begin
    ...
    begin
        ...
        SetCell(RowNo, ColumnNo, pRec.FieldCaption("Direct Unit Cost"), true, false, '', ExcelBuffer."Cell Type"::Text); // 6
    ...
    begin
        ...
        if pRec.Type <> pRec.Type::" " then begin
            ...
            SetCell(RowNo, ColumnNo, Format(pRec."Direct Unit Cost"), false, false, '', ExcelBuffer."Cell Type"::Number); // 6
