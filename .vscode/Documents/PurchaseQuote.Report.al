report 87404 "wan Purchase - Quote"
// Copy from "Standard Purchase - Order", 'Order' replaced by 'Quote' + '[+ wan Extension +]
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            RequestFilterHeadingML = ENU = 'Purchase - Quote', FRA = 'Demande de prix';
    ...
    var
        ...
        DocumentTitleLbl: TextConst ENU = 'Purchase Quote', FRA = 'Demande de prix';
        ...
        BodyLbl: TextConst ENU = 'The purchase quote is attached to this message.', FRA = 'La demande de prix est jointe à ce message';
    ...
    //wanMailBody_Lbl: TextConst ENU = 'Please find attached a request for quotation, to which we kindly ask you to respond as soon as possible.', FRA = 'Veuillez trouver ci-joint une demande de prix, à laquelle nous vous demandons de bien vouloir répondre dès que possible.';
