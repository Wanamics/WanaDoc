...
pageextension 87346 "wan Sales Order Subform" extends "Sales Order Subform"
{
    actions
    {
        addlast(processing)
...
pageextension 87347 "wan Sales Invoice Subform" extends "Sales Invoice Subform"
{
    actions
    {
        addlast(processing)
...
pageextension 87395 "wan Sales Quote Subform" extends "Sales Quote Subform"
{
    actions
    {
        addlast(processing)
...
pageextension 87396 "wan Sales Cr.Memo Subform" extends "Sales Cr. Memo Subform"
{
    actions
    {
        addlast(processing)
...
pageextension 87308 "wan Blanket Sales Order Sub." extends "Blanket Sales Order Subform"
{
    actions
    {
        addlast(processing)
