...
codeunit 87300 "wan Sales Prepayment Events"
{
        ...
        if FromLine.FindSet() then
            repeat
                if ToLine.Get(SalesInvHeader."No.", FromLine."Line No.") then begin
                    ...
                    ToLine."wan Indentation" := FromLine."wan Indentation";
                    ToLine.Modify(false)
                end else begin
    ...
    */
    ...
    begin
        ...
        if TempExtendedTextLine.FindSet() then
            repeat
                ...
                ExtendedLine."wan Indentation" := SalesInvLine."wan Indentation";
                ExtendedLine.Insert();
    ...
    begin
        if SalesInvHeader."wan Compress Prepayment" then
            exit;
        SalesInvLine."Line No." := PrepmtInvLineBuffer."Line No.";
    end;
}
