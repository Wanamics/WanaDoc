...
codeunit 87303 "WanaDoc Purchase Events"
{
    ...
    [EventSubscriber(ObjectType::Table, Database::"Purchase Header", OnUpdatePurchLinesByFieldNoOnAfterPurchLineSetFilters, '', false, false)]
    local procedure OnUpdateSalesLinesByFieldNoOnAfterSalesLineSetFilters(var PurchaseHeader: Record "Purchase Header"; xPurchaseHeader: Record "Purchase Header"; var PurchaseLine: Record "Purchase Line"; ChangedFieldNo: Integer)
    begin
