...
reportextension 87306 "wan Standard Sales - Invoice" extends "Standard Sales - Invoice"
{
    dataset
    {
        ...
        modify(Header)
        {
            ...
            begin
                AddressesHelper.SetInvoiceAddresses(Header, SellToAddress, ShipToAddress, BillToAddress);
        ...
        modify(Line)
        {
            ...
            begin
                ...
                case true of
                    ...
                    Header."Prepayment Invoice" and not Header."wan Compress Prepayment":
                        begin
    ...
    rendering
    {
        ...
        {
            Type = Word;
            LayoutFile = './ReportLayouts/wanSalesInvoice.docx';
            Caption = 'WanaDoc Sales Invoice (Word)';
            Summary = 'The WanaDoc Sales Invoice (Word) provides a detailed layout.';
        }
    }
    protected var
    ...
    [IntegrationEvent(true, false)]
    local procedure OnAfterFetchContent(pHeader: Record "Sales Invoice Header"; pPlaceHolder: Enum "wan Document Content Placement"; var ReturnValue: Text)
    begin
    end;
}