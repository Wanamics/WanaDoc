...
// Copy from report 1305 "Standard Sales - Order Conf." + //[ ... //] from extension
{
    ...
    DefaultRenderingLayout = "WanaDoc";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            RequestFilterHeading = 'Sales Blanket Order';
    ...
    rendering
    {
        ...
        {
            Type = Word;
            LayoutFile = './ReportLayouts/wanSalesBlanketOrder.docx';
    ...
    var
        ...
        InvNoLbl: Label 'Blanket Order No.';
        ...
        BodyLbl: Label 'Thank you for your business. Your blanket order is attached to this message.';
    ...
    protected var
        ...
        SalesConfirmationLbl: Label 'Blanket Order';
