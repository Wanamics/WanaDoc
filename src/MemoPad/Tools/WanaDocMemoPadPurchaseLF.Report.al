...
report 87302 "WanaDoc MemoPad Purchase LF"
{
    Caption = 'WanaDoc MemoPad Set Purchase LineFeed', Locked = true;
    UsageCategory = None;
    ApplicationArea = All;
    ProcessingOnly = true;
    Permissions =
    ...
    dataset
    {
        ...
        dataitem("Shipment Line"; "Purch. Rcpt. Line")
        {
            DataItemTableView = where("Attached to Line No." = filter(<> 0));
        ...
        dataitem("Invoice Line"; "Purch. Inv. Line")
        {
            DataItemTableView = where("Attached to Line No." = filter(<> 0));
            RequestFilterFields = "Document No.";
        ...
        dataitem("Cr.Memo Line"; "Purch. Cr. Memo Line")
        {
            DataItemTableView = where("Attached to Line No." = filter(<> 0));
            RequestFilterFields = "Document No.";
        ...
        dataitem("Return Line"; "Return Shipment Line")
        {
            DataItemTableView = where("Attached to Line No." = filter(<> 0));
            RequestFilterFields = "Document No.";
        ...
        dataitem(LineArchive; "Purchase Line Archive")
        {
            DataItemTableView = where("Attached to Line No." = filter(<> 0));
            RequestFilterFields = "Document Type", "Document No.";
