...
reportextension 87311 "wan Sales Invoice Indent." extends "Standard Sales - Invoice"
{
    ...
    local procedure SetTotalAmounts(var pTotalLine: Record "Sales Invoice Line"; var pTotalLineAmount: Text; var pTotalPrepmtLineAmount: Text; var pTotalPrepmtAmtInvLineAmount: Text);
    var
